...
- [src port, dst port, seq, ack, header len, reserved, **control bits**, **window**, checksum, urgent]
- **seq: data reassembly; ack: received and next expected**
- window: dst can accept and process, (**src won't decrease even net conjestion**)
